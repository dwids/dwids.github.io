---
date: 2020-04-07T18:49:14.000Z
lastmod: 2024-11-21T22:14:55.000Z
...
I&#8217;m on Android and use the free [BeyondPod ](http://www.beyondpod.mobi/Android/index.htm#top)app. I&#8217;ve been using it for years. It lets me manage my **subscriptions **to the *current podcast feeds*, so I automatically find out when new episodes of a show/series are available. Plus it&#8217;s the player.  Why I like it:
...
For example my GoTo podcast is ABC RN&#8217;s Late Night Live.  And their [podcast archive](https://www.abc.net.au/rn/features/inbedwithphillip/) looks like this:
![](/images/wordpress/2021/02/2_image-2.png)
...
![](/images/wordpress/2021/02/1_image-4.png)
...
After some trial and error, I found a free mp3 player called [Pulsar](https://play.google.com/store/apps/details?id=com.rhmsoft.pulsar&amp;hl=en) that supports variable speed playback. The only folder it is configured to use is *mypodcasts*; so it doesn&#8217;t try and read and play my music mp3 files.
...
On the PC, I use the free MP3 tag editor **[Mp3tag ](https://www.mp3tag.de/en/)**for both music and podcast files, to easily change the tags, like Album, Title and Artist.  I do this **before **copying them to the phone (the app can change it, but easier on the PC). 
...
![](/images/wordpress/2021/02/1_image-5.png)
...
![](/images/wordpress/2021/02/screenshot_20200407-182703.png)
