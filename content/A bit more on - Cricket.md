...
So there is no room for single error in the batting. 

There are two batters, we'll call them *Goode* and *David*   You can work out who is the better batter and who is me, sorry, who is not so good[^1]

Goode - who is facing the bowler (on 'strike') - has to take control and "Farm the Strike". A new Over has started and Goode knows if they hit (1 or 3) run(s) that will expose David to 5 balls. Ouch. Chances are David will go out and Australia will lose.

So Goode can try and hit 2 (thus Goode stays on strike). Ditto by hitting a 4 or 6 (risky!).  If they hit an 'obvious' single (1 run) they will probably NOT RUN so early in the Over.

By ball 5 of the 6, Goode has to reverse this thinking. They **have** to hit a 1 or 3 in the next ball or the last one (ball 6), so they and David can swap ends. Doing so, leaves David to face 1 or (ideally) zero balls in that Over. At the end of the Over, Goode is back on Strike.

This leads to some unforgettable moments

- After 4 days (4 x 6 = 24 hours on the field) and 5  1/2 hours of play (today) it has come down to something like this above. 
