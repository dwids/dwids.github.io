---
date: 2020-05-16T18:48:23.000Z
lastmod: 2024-11-21T21:49:58.000Z
...
![](/images/wordpress/2021/02/ss.20200516.154004.jpg)Source: same as above
Of course, this is ignoring air resistance.

Also, as an important aside: you may have spotted something missing from those simple equations. **Mass**. The mass of the object &#8211; in kg &#8211; is NOT needed here. *All things fall at the same rate*, assuming no air resistance. [Even a feather and a hammer](https://youtu.be/oYEgdZ3iEKA). (That video is still quite gobsmacking no matter how many times I see it. The Moon has no air, so no air resistance)

OK, the value of (little) **g** is different on different planets etc. We turn to Newton to work out this value for Earth, M[a](https://youtu.be/AZKcl4-tcuo)rs etc. Never forget Newton was working on this gravity stuff in the **1680s **(!), including the maths.

Again the formula is quite basic:
![](/images/wordpress/2021/02/image-7.png)
...
![](/images/wordpress/2021/02/ss.20200516.185401.jpg)Source: [https://en.wikipedia.org/wiki/Black_hole_thermodynamics](https://en.wikipedia.org/wiki/Black_hole_thermodynamics)
...
![](/images/wordpress/2021/02/image-8.png)(phew, they are right)
Here are the Excel calculations done:
![](/images/wordpress/2021/02/image-9.png)Yes &#8220;G&#8221; is called &#8220;Big G&#8221; as I said earlier.
...
[Wikipedia ](https://en.wikipedia.org/wiki/Galileo%27s_Leaning_Tower_of_Pisa_experiment)says it well, so here it is:
