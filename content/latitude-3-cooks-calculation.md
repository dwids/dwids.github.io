...
![](zenith-distance-and-altitude.png)Stellarium simulation. &#8220;Fish-eye&#8221; lens mode, to show the Zenith which is actually directly overhead
...
![](zenith-distance-diagram.jpg)His **Situation**. ZD = Zenith Distance (actually an angle)
...
![](zenith-distance-declination-and-latitude-diagram.jpg)To repeat: only true for the Meridian Pass. Hence that&#8217;s why it&#8217;s used.
...
>[!info] Back to [[latitude-01-what-is-it|Part 1]]
