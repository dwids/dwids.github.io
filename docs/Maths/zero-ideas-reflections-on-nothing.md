...
*Add* zero to a number and there's no change. *Subtract* zero and there's no change. Do either (or both) 32 more times: no change. `x plus or minus 0 is still x` or, formally,   $x \pm 0 = x$  
...
One [source](https://www.scientificamerican.com/article/what-is-the-origin-of-zer/) writes 
