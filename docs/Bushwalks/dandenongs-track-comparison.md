...
|------|-----------|-----------------|----------------------|
| Bills Track | 2601 | 112 | 43% |
| Rankin Tk | 5851 | 114 | 19% |
...
Here’s the graphs. Hopefully it makes sense. I did it with the same scale for both axes (approx.), so the slopes are realistic.  

![](Dandenongs-Walks-Gradients_.png)

Here they are on the one Google Earth screen. Closest = 1000 Steps (red), then Bills (green), Rankin (orange) and Glasgow (blue).  Height doubled for effect. 

![](d6328-dandenongs-walks_thumb.png)
