---
date: 2008-07-23T12:03:59.000Z
lastmod: 2008-07-23T12:03:59.000Z
...
And so when later on I looked back at my [tag lists](__GHOST_URL__/topics/) I had three new topics/tags. Ouch.  I only wanted the one!
...
> Controlled vocabularies provide a way to organize knowledge for subsequent retrieval. They are used in [subject indexing](http://en.wikipedia.org/wiki/Subject_indexing) schemes, [subject headings](http://en.wikipedia.org/wiki/Subject_heading), [thesauri](http://en.wikipedia.org/wiki/Thesauri) and [taxonomies](http://en.wikipedia.org/wiki/Taxonomies). Controlled vocabulary schemes mandate the use of predefined, authorised terms that have been preselected by the designer of the vocabulary, in contrast to [natural language](http://en.wikipedia.org/wiki/Natural_language)[vocabularies](http://en.wikipedia.org/wiki/Vocabularies), where there is no restriction on the vocabulary.   

Source: [http://en.wikipedia.org/wiki/Controlled_vocabulary](http://en.wikipedia.org/wiki/Controlled_vocabulary)
