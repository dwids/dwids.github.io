...
Anyway it’s a [Garmin eTrex Vista HCx](https://wiki.openstreetmap.org/wiki/Garmin/eTrex_Vista_HCx) model, which I purchased new from the USA (from *Geomangear*).  Even with the postage it was much cheaper than buying it locally. And it took only 5 days to get here!
